...
const AboutSection = () => {
    return (
        <section className="overflow-hidden pb-12 lg:pt-[50px] lg:pb-[90px] bg-white sm:pt-[25px]">
        <div className="container mx-auto">
          <div className="lg:flex lg:flex-wrap items-center justify-between lg:-mx-4">
            <div className="w-full px-10 pt-10 lg:w-6/12">
              <div className="flex items-center -mx-3 sm:-mx-4">
                <div className="px-3 sm:px-4 w-1/2">
                  <div className="py-3 sm:py-4 rounded-lg">
                    <img
                      src="/images/cleaning_3team.png"
                      alt=""
                      className="rounded-2xl lg:w-full lg:rounded-2xl"
                    />
                  </div>
                  <div className="py-3 sm:py-4">
                    <img
                      src="/images/resco_poses.png"
                      alt=""
                      className="rounded-2xl lg:w-full lg:rounded-2xl"/>
                  </div>
                </div>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                Delight your customers with exceptional cleaning services.
                </span>
                <h2 className="mb-5 text-5xl font-bold text-dark dark:text-white sm:text-[40px]/[48px]">
                ...
                We use eco-friendly products and proven cleaning methods to ensure a healthy environment for you and your family or employees.
                </p>  
